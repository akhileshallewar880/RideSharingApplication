...
class AdminEnvironmentConfig {
  ...
  static const Map<AdminEnvironment, String> _apiBaseUrls = {
    AdminEnvironment.development: 'https://vanyatraapp-e4g4ggamaeaeeafm.centralindia-01.azurewebsites.net', // Local Server API
    AdminEnvironment.staging: 'https://vanyatraapp-e4g4ggamaeaeeafm.centralindia-01.azurewebsites.net',
    AdminEnvironment.production: 'https://vanyatraapp-e4g4ggamaeaeeafm.centralindia-01.azurewebsites.net', // Production Server
  };
